        ...
        <div className="container hero-grid">
          <div className="reveal">
            ...
            <div className="actions">
              <Link className="btn btn-primary" href="/projects" data-i18n="explore">Explore My Work <ArrowUpRight size={16} /></Link>
