    ...
    <main>
      ...
      <section id="top" className="hero">
        ...
        <div className="container hero-grid">
          ...
          <div className="hero-card reveal delay"><div className="hero-portrait"><img src="https://avatars.githubusercontent.com/u/313960239?v=4" alt="Yusuf B. Situmorang" width={900} height={900} loading="eager" /><div className="portrait-shade" /><div className="portrait-frame" /><div className="portrait-caption"><strong>Build. Serve. Grow. Give.</strong><span>Finance • Business • Technology • Purpose</span></div></div></div>
        </div>
      ...
      <section className="section what-i-do"><div className="container"><div className="section-head"><div><div className="kicker">01.5 / What I Do</div><h2>Turning complexity into clarity.</h2></div><p className="section-lead">I connect finance, business thinking and emerging technology to make better decisions, build useful systems and create measurable value.</p></div><div className="what-grid"><article><div className="what-icon"><Calculator size={20}/></div><span>01</span><h3>Finance</h3><p>Accounting, tax, financial analysis, reporting, controls and decision support.</p></article><article><div className="what-icon"><Building2 size={20}/></div><span>02</span><h3>Business</h3><p>Strategy, operating systems, venture building, commercial thinking and growth.</p></article><article><div className="what-icon"><Sparkles size={20}/></div><span>03</span><h3>Technology & AI</h3><p>AI-assisted workflows, automation, data and software experiments that turn ideas into leverage.</p></article></div></div></section>
      ...
      <section className="section digital-presence-section"><div className="container"><div className="section-head"><div><div className="kicker">06.5 / Digital Presence</div><h2>Follow the work as it compounds.</h2></div><p className="section-lead">The public portfolio is one layer of a wider body of work. Follow the channels where I share ideas, experiments, lessons and new projects.</p></div><div className="presence-grid">{socials.map(([name, url, desc, Icon]) => <a className="presence-card" href={url} target="_blank" rel="noreferrer" key={name}><span className="presence-icon"><Icon size={21} /></span><span><strong>{name}</strong><small>{desc}</small></span><ArrowUpRight size={16} /></a>)}</div></div></section>
