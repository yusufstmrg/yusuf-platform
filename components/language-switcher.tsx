...
const translations: Record<string, string> = {
  ...
  "Choose the reason you're reaching out.":"Pilih alasan Anda menghubungi saya.",
  "How this portfolio will compound.":"Bagaimana portofolio ini akan bertumbuh secara majemuk.",
  ...
  "Back to Yusuf":"Kembali ke Yusuf",
  "Back to projects":"Kembali ke proyek",
  "Open WhatsApp":"Buka WhatsApp",
  "Hire / Engage":"Hire / Engage",
  "Career / Recruitment":"Karier / Rekrutmen",
  "Collaborate":"Kolaborasi",
  "Speaking / Content":"Speaking / Konten",
  "Currently building":"Sedang dibangun",
  "In progress":"Sedang dikerjakan",
  "Current state":"Status saat ini",
  "Published proof":"Bukti yang dipublikasikan",
  "Current builds":"Pembangunan saat ini",
  "Proof of work, built in public.":"Bukti karya, dibangun secara terbuka.",
  "Ideas worth sharing.":"Ide yang layak dibagikan.",
  "The Direction":"Arah",
  "Career Capital Strategy":"Strategi Modal Karier",
  "How the stack compounds":"Bagaimana kapabilitas ini bertumbuh",
  "Discuss this project":"Diskusikan proyek ini",
  "Interested in the work or want to collaborate?":"Tertarik dengan karya ini atau ingin berkolaborasi?",
  "Finance":"Keuangan",
  "Business":"Bisnis",
  "Technology & AI":"Teknologi & AI",
  "Accounting & Tax":"Akuntansi & Pajak",
  "Financial Analysis":"Analisis Keuangan",
  "Corporate Finance":"Keuangan Korporasi",
  "AI & Technology":"AI & Teknologi",
  "Business Building":"Membangun Bisnis",
  ...
  "Work / Collaborate":"Bekerja / Berkolaborasi",
  "Stay connected":"Tetap Terhubung",
  "Contact page":"Halaman Kontak",
  "General WhatsApp":"WhatsApp Umum",
  "Privacy by default":"Privasi sebagai standar",
  "Finance Foundation":"Fondasi Keuangan",
  "AI Focused":"Berfokus pada AI",
  "Purpose Driven":"Berorientasi pada Tujuan",
  "Years":"Tahun",
  "Certifications":"Sertifikasi",
  "Focused":"Fokus",
  "Driven":"Berorientasi",
  "About / The Story":"Tentang / Cerita",
  "Expertise / Capability Stack":"Keahlian / Kapabilitas",
  "Experience / Career Journey":"Pengalaman / Perjalanan Karier",
  "Projects / Proof of Work":"Proyek / Bukti Karya",
  ...
  "Master the foundation":"Kuasai fondasi",
  "Build leverage":"Bangun leverage",
  "Turn value into impact":"Ubah nilai menjadi dampak",
  "Finance authority":"Otoritas finance",
  "Business + technology":"Bisnis + teknologi",
  "Visible body of work":"Body of work yang terlihat",
  "Established finance capability forms the base; business, data, AI and communication are the layers being intentionally compounded.":"Kapabilitas finance yang sudah terbentuk menjadi fondasi; bisnis, data, AI, dan komunikasi adalah lapisan yang sengaja dikembangkan secara kumulatif.",
  ...
  "A foundation in accounting and tax, deliberately expanding toward financial decision support, business building and technology.":"Fondasi accounting dan tax yang terus diperluas menuju financial decision support, business building, dan technology.",
  ...
  "Only explicitly published projections appear here. Private and draft work remains in the Personal OS.":"Hanya karya yang secara eksplisit dipublikasikan yang tampil di sini. Pekerjaan private dan draft tetap berada di Personal OS.",
  ...
  "I connect finance, business thinking and emerging technology to make better decisions, build useful systems and create measurable value.":"Saya menghubungkan finance, business thinking, dan emerging technology untuk membuat keputusan yang lebih baik, membangun sistem yang berguna, dan menciptakan nilai yang terukur.",
  ...
  "Follow the work as it compounds.":"Ikuti perkembangan karya ini seiring nilainya bertumbuh.",
  "The public portfolio is one layer of a wider body of work. Follow the channels where I share ideas, experiments, lessons and new projects.":"Portofolio publik adalah salah satu lapisan dari body of work yang lebih luas. Ikuti kanal tempat saya membagikan ide, eksperimen, pembelajaran, dan proyek baru.",
  ...
  "AI Chief of Staff":"AI Chief of Staff",
  "Reviews, bottleneck detection and next-best actions.":"Reviews, deteksi bottleneck, dan next-best actions.",
  "Open Build":"Open Build",
  "Selected technical experiments and future proof-of-work.":"Eksperimen teknis pilihan dan future proof-of-work.",
  "Build in Public":"Build in Public",
  "Documenting what I learn and build across media.":"Mendokumentasikan apa yang saya pelajari dan bangun melalui berbagai media.",
  "Contextual WhatsApp messages make it easier for you to start a useful conversation—and easier for me to understand what you need.":"Pesan WhatsApp yang kontekstual memudahkan Anda memulai percakapan yang berguna—dan membantu saya memahami kebutuhan Anda.",
  ...
  "Discuss an Opportunity":"Diskusikan Peluang",
  "Explore Projects":"Jelajahi Proyek",
