...
const idByEnglish: Record<string, string> = {
  ...
  "Turning complexity into clarity.":"Mengubah kompleksitas menjadi kejelasan.","Numbers are only the beginning.":"Angka hanyalah permulaan.","A stack built for leverage.":"Kapabilitas yang dibangun untuk leverage.","A finance career in progress.":"Perjalanan karier finance yang terus berkembang.","Proof, not promises.":"Bukti, bukan janji.","Learning in public.":"Belajar secara terbuka.","Building the system behind the journey.":"Membangun sistem di balik perjalanan.","Choose the reason you're reaching out.":"Pilih alasan Anda menghubungi saya.","How this portfolio will compound.":"Bagaimana portofolio ini akan bertumbuh secara majemuk.","Show, don’t tell":"Tunjukkan, jangan hanya katakan","Build in public":"Bangun secara terbuka","Compound value":"Nilai yang berlipat","Follow the work as it compounds.":"Ikuti perkembangan karya yang terus bertumbuh.",
  "Back to Yusuf":"Kembali ke Yusuf","Back to projects":"Kembali ke proyek","Open WhatsApp":"Buka WhatsApp","Hire / Engage":"Hire / Engage","Career / Recruitment":"Karier / Rekrutmen","Collaborate":"Kolaborasi","Speaking / Content":"Speaking / Konten","Currently building":"Sedang dibangun","Published proof":"Bukti yang dipublikasikan","Current builds":"Yang sedang dibangun","Proof of work, built in public.":"Bukti karya, dibangun secara terbuka.","Ideas worth sharing.":"Ide yang layak dibagikan.",
  ...
  "Finance is the foundation. Building is the direction.":"Finance adalah fondasi. Building adalah arah.","A deeper look at the person, principles and trajectory behind the public portfolio.":"Melihat lebih dekat pribadi, prinsip, dan arah perjalanan di balik portofolio publik.","A foundation in accounting and tax, deliberately expanding toward financial decision support, business building and technology.":"Fondasi di bidang akuntansi dan pajak yang terus diperluas menuju dukungan keputusan keuangan, pembangunan bisnis, dan teknologi.","Master the foundation":"Kuasai fondasi","Build leverage":"Bangun leverage","Turn value into impact":"Ubah nilai menjadi dampak",
  "Established finance capability forms the base; business, data, AI and communication are the layers being intentionally compounded.":"Kapabilitas finance yang sudah kuat menjadi fondasi; bisnis, data, AI, dan komunikasi adalah lapisan yang sengaja terus dikembangkan.","Finance depth":"Kedalaman finance","Technology + AI":"Teknologi + AI","Communication + audience":"Komunikasi + audiens",
  "Only explicitly published projects appear here. Private and draft work remains in the Personal OS.":"Hanya proyek yang secara eksplisit dipublikasikan yang tampil di sini. Data privat dan draft tetap berada di Personal OS.","Have a project that could benefit from this skill stack?":"Punya proyek yang bisa mendapatkan manfaat dari kapabilitas ini?",
  "Practical ideas across finance, business, AI, career growth and purpose—shared while the underlying knowledge is being built.":"Gagasan praktis tentang finance, bisnis, AI, perkembangan karier, dan purpose—dibagikan sambil pengetahuan dasarnya terus dibangun.","Professional authority":"Otoritas profesional","Personal brand":"Personal brand","Short-form ideas":"Ide short-form","Deep-dive content":"Konten mendalam",
  "The public portfolio is one layer of a wider body of work. Follow the channels where I share ideas, experiments, lessons and new projects.":"Portofolio publik adalah salah satu lapisan dari keseluruhan karya. Ikuti kanal tempat saya membagikan ide, eksperimen, pelajaran, dan proyek baru.","Reviews, bottleneck detection and next-best actions.":"Review, deteksi bottleneck, dan next-best actions.","Selected technical experiments and future proof-of-work.":"Eksperimen teknis terpilih dan proof-of-work yang akan datang.","Documenting what I learn and build across media.":"Mendokumentasikan apa yang saya pelajari dan bangun di berbagai media.",
  "For consulting, finance/business projects and professional engagements.":"Untuk konsultasi, proyek finance/bisnis, dan engagement profesional.","For recruiters and employers exploring relevant roles, interviews or talent conversations.":"Untuk recruiter dan perusahaan yang mengeksplorasi posisi, interview, atau percakapan talent yang relevan.","For partnerships, products, content, business ventures and strategic collaborations.":"Untuk partnership, produk, konten, venture bisnis, dan kolaborasi strategis.","For speaking, knowledge-sharing, interviews, podcasts and creator collaborations.":"Untuk speaking, knowledge-sharing, interview, podcast, dan kolaborasi creator.","General WhatsApp":"WhatsApp Umum","Contact page":"Halaman Kontak",
  "Public profile":"Profil publik","Command your next move.":"Kendalikan langkah berikutnya.","One operating system.":"Satu operating system.","Operating loop":"Operating loop","Quick Capture":"Quick Capture","Building the system behind the journey.":"Membangun sistem di balik perjalanan.","Yusuf Personal OS":"Yusuf Personal OS"
};
...
function translateDocument(lang: "en" | "id") {
  ...
  const map = lang === "id" ? idByEnglish : enById;

  document.querySelectorAll<HTMLElement>("[data-i18n]").forEach((node) => {
    const pair = node.dataset.i18n ? keyMap[node.dataset.i18n] : undefined;
    if (pair) node.textContent = pair[lang === "en" ? 0 : 1];
  });
  ...
  document.querySelectorAll<HTMLElement>("body *").forEach((node) => {
    ...
    if (!original || original.length > 240) return;
